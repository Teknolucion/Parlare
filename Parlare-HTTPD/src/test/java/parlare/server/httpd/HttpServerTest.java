...
//        assertEquals(expected.length, lines.size());
    ...
    protected ByteArrayOutputStream invokeServer(String request) {
        ...
        ParlareHTTPD.HTTPSession session = testServer.createSession(tempFileManager, inputStream, outputStream);
        try {
            session.execute();
        } catch (IOException e) {
            fail(""+e);
    ...
    public static class TestTempFileManager extends ParlareHTTPD.DefaultTempFileManager {
        public void _clear() {
            super.clear();
        }
    ...
    public static class TestServer extends ParlareHTTPD {
        ...
        public Response serve(String uri, Method method, Map<String, String> header, Map<String, String> parms, Map<String, String> files) {
            ...
            this.decodedParamters = decodeParameters(parms.get("ParlareHTTPD.QUERY_STRING"));
            return response;
        }
